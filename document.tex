...
\textrm{sen}\,\alpha
$$
nótese que hay que poner \verb!\,! para que lo que vaya después de la <<nueva
función>> se separe un poco de ella y quede como si fuera una de las de 
\LaTeX{}.
...
de la matriz entre paréntesis está definida entre las líneas y 8, la segunda
...
todo esto se aáde una matrix de $4\times 1$, donde la primera fila está vacía
(línea 22).
...
y \verb!\( \)!, siendo el primero equivalente a los dos signos de dolar y el
...
\texttt{amsmath} requiere para funcionar. Además, amsmath no funciona con el 
comando \verb!\matrix! sino que requiere el uso de un entorno que él mismo
...
ver ejemplo simples de las funciones citadas enteriormente se puede ver el 
...
3    \fancyhead[C]{
 \   \Large\titulo\normalsize\\
  ...
  |  \leftmark
  \- }
4    \fancyhead[R]{\includegraphics[height=2cm]{escudo}}
