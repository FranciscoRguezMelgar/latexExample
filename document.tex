...
\begin{figure}[H]
    ...
    \caption{Vetana principal de TexStudio}
    \label{fig:texstudio}
\end{figure}
...
sería la matrix. Para crear una matriz se usaría:
\begin{verbatim}
\matrix{1&2&3 \cr 
           4&5&6 \cr
           7&8&9}
...
símbolo que queramos utilizar, por ejemplo si queremos una matrix rodeada
...
\int{x \, dx }
$$
Nótese que es necesario poner \texttt{\textbackslash ,} para que se genera
...
\int{\int{\int_{0}^{10}{f(x,y,z)\,dx\,dy\,dz}}}
$$
Si se requiete la integral de superficie se puede usar la orden
