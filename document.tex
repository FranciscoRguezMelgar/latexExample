...
\begin{enumerate}
\item \texttt{\textbackslash{pagestyle\{fancy\}}}: esto indica que queremos
usar el estilo de encabezado y pie personalizado.
\item \texttt{\textbackslash{fancyhf\{\}}}: Dibuja una línea fina en el 
encabezado que enmarca la página.
\item \texttt{\textbackslash{fancyhead[<pos>]\{<contenido>\}}}: 
    \begin{enumerate}
...
\texttt{\textbackslash{fancyfoot[<pos>]\{<contenido>\}}}, que es la que se usa
...
\texttt{\textbackslash{}pageref\{LastPage\}}
...
\texttt{\textbackslash{documentclass[twoside]\{article\}}} podremos seleccionar
...
par se usaría el comando \texttt{\textbackslash{cleardoublepage}}. Si se va
